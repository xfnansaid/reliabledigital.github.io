;(function () {
	...
	$(document).ready(function () {
		$('.flexslider').flexslider({
		  animation: "fade",  // You can change this to "slide"
		  controlNav: true,   // Enables the navigation dots
		  directionNav: false, // Hides next/prev arrows
		  slideshowSpeed: 5000, // Adjust the speed (5000ms = 5 sec)
		  animationSpeed: 600, // Speed of transition
		  smoothHeight: true // Ensures the height doesn't change
		});
	  });
